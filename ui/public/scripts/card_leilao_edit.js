...
function setupCountdown(auction) {
  ...
  function updateCountdown() {
    ...
    document.getElementById(`days-${auction.id}`).textContent = String(
      days,
    ).padStart(2, "0");
    document.getElementById(`hours-${auction.id}`).textContent = String(
      remainingHours,
    ).padStart(2, "0");
    document.getElementById(`minutes-${auction.id}`).textContent = String(
      remainingMinutes,
    ).padStart(2, "0");
    document.getElementById(`seconds-${auction.id}`).textContent = String(
      remainingSeconds,
    ).padStart(2, "0");
  }
